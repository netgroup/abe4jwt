...
@ThreadSafe
public abstract class Decrypter implements JWEDecrypter {
...
//	for the time now just use a key encoded as Base64URL 
	protected Base64URL privateKey;
	public Decrypter(final Base64URL privateKey) {
		this.privateKey=privateKey;
	}
	
	public abstract byte[] decrypt(final JWEHeader header, final Base64URL encryptedKey, final Base64URL iv, final Base64URL cipherText, final Base64URL authTag) throws JOSEException;
